...
const Home = () => {
  return (
    <div className="home-container">
      ...
      <p>
        Únete a nuestra escuela para disfrutar de actividades emocionantes como
        Snowboard, Ski y Moto de Nieve.
      </p>
      ...
      <p>
        ...
        asegurar que tengas todo lo necesario para disfrutar de las actividades.
      </p>
    </div>
  );
};
